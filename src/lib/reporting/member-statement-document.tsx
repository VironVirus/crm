...
export function MemberStatementDocument({
  ...
  return (
    <Document
      author="Ifemelunma Cooperative Society"
      ...
      <Page size="A4" style={styles.page}>
        <View style={styles.header}>
          ...
          <View style={styles.brandBlock}>
            <Text style={styles.title}>Ifemelunma Cooperative Society</Text>
        ...
        <Text style={styles.footer}>
          Generated by Ifemelunma Cooperative Society administrative reporting
          module.
        </Text>
      </Page>
    </Document>
