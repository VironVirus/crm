      ...
      <Page size="A4" style={styles.page}>
        <View style={styles.header}>
          <View style={styles.logoPlaceholder}>
            <Text style={styles.logoText}>IMPCS</Text>
          </View>

          <View style={styles.brandBlock}>
            <Text style={styles.title}>{COOPERATIVE_NAME}</Text>
        ...
        <Text style={styles.footer}>
          Generated by {COOPERATIVE_NAME} administrative reporting module.
        </Text>
      </Page>
    </Document>
  );
